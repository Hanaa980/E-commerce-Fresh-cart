  ...
  return (
    <>
      ...
      <form
        ...
        className="mt-[100px]  w-6/12 m-auto mb-5"
      >
        {apiError ? (
          <div
        ...
        <div className="mb-5">
          ...
          <input
            ...
            id="emailInput"
            name="email"
            value={formikForgetPass.values.email}
            onBlur={formikForgetPass.handleBlur}
            onChange={formikForgetPass.handleChange}
        ...
        >
          {isLoader ? <ClipLoader size={20} color="#ffffff" /> : "send code"}
        </button>
      </form>
    </>
  );
