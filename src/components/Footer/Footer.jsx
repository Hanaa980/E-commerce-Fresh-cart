        ...
        <div className=" bg-gray-900">
          <div className="py-11 px-5 flex flex-col sm:flex-row flex-wrap md:flex-nowrap justify-between text-white ">
            <div className="w-[33%]">
              ...
              <p className="my-2 text-gray-300 w-40">
                Your trusted partner for original products delivered with care.
            ...
            <div className="w-[100%] md:w-[33%] ">
              ...
              <ul className="flex flex-col sm:flex-row md:flex-col justify-between gap-10 ">
                ...
                <li>
                  ...
                  <span> giza,Eygpt</span>
                </li>
              </ul>
            </div>
          </div>
          <hr />
          <p className="mt-4 py-5 text-center text-white ">
            © 2025 FreshCart. All rights reserved.
            <br /> Made with
            <span className="font-extrabold text-lg">Hanaa Ragab</span>
