...
export default function VerifyCode() {
  ...
  return (
    ...
    <div className="mb-5">
              <label htmlFor="codeInput" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Code</label>
              <input type="text" id="codeInput" name="resetCode" value={formikCode.values.resetCode} onBlur={formikCode.handleBlur} onChange={formikCode.handleChange} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-main focus:border-main block w-full p-2.5" />
              {formikCode.errors.resetCode && formikCode.touched.resetCode ? <div className="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">{formikCode.errors.resetCode}
              </div> : " "}
            </div>
